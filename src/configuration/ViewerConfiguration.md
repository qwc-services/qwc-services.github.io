...
|`kinetikPanParams`                   | Kinetic inertia to apply to the pan. Format: `{"decay": <number>, "minVelocity": <number>, "delay": <number>}`. By default this is set to `null`, which deactivates the Kinetic inertia panning |
